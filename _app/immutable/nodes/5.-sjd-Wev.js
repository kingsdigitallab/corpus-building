import{c as y,a as s,t as n,s as w}from"../chunks/disclose-version.QrToNDMC.js";import"../chunks/legacy.CJmSs4Gq.js";import{Z as v,_ as p,$ as x,a3 as _,a2 as h,a5 as j,a0 as d,a1 as u,a4 as S}from"../chunks/runtime.DiKes7Fb.js";import{l as k,s as E}from"../chunks/props.C7uqbzm7.js";import{s as T,t as $}from"../chunks/config.DknOfkB7.js";import{s as m}from"../chunks/attributes.DXNZsd4Q.js";var z=n('<meta name="description"> <meta name="tags">',1),I=n("<article><h1> </h1> <!></article>");function L(i,e){v(e,!0);var t=I();y(f=>{var l=z(),c=_(l),g=h(c,2);p(b=>{j.title=`${e.title??""} | ${$??""}`,m(c,"content",e.excerpt),m(g,"content",b)},[()=>e.tags.join(", ")]),s(f,l)});var a=d(t),r=d(a,!0);u(a);var o=h(a,2);T(o,e,"default",{}),u(t),p(()=>w(r,e.title)),s(i,t),x()}const D={title:"About",excerpt:"I.Sicily is a long-term project to construct and maintain a digital corpus of the inscriptions of ancient Sicily.",tags:["about","project","sicily","inscriptions"]};var W=n(`<p>I.Sicily is a long-term project to construct and maintain a digital corpus of
...
brick and tile, and coin legends.</p> <p>I.Sicily employs the <a href="https://sourceforge.net/p/epidoc/wiki/Home/" rel="nofollow">EpiDoc TEI-XML standard</a>.
...
bibliography (in <a href="https://www.zotero.org/groups/382445/isicily/library" rel="nofollow">Zotero</a>)
and collection information through a database of <a href="http://sicily.classics.ox.ac.uk/museums" rel="nofollow">Sicilian museums</a>.
...
vocabularies</a>.</p>`,1);function Z(i,e){const t=k(e,["children","$$slots","$$events","$$legacy"]);L(i,E(()=>t,D,{children:(a,r)=>{var o=W();S(4),s(a,o)},$$slots:{default:!0}}))}export{Z as component};
