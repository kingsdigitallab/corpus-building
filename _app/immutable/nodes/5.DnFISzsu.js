import{a as s,t as n}from"../chunks/disclose-version.B-t4LT19.js";import"../chunks/legacy.Ch8ywPcB.js";import{n as r}from"../chunks/runtime.BfEhbvMC.js";import{l,s as c}from"../chunks/props.JFTOXSWA.js";import{B as h}from"../chunks/BaseLayout.KUnbB3rf.js";const p={title:"About",excerpt:"I.Sicily is a long-term project to construct and maintain a digital corpus of the inscriptions of ancient Sicily.",tags:["about","project","sicily","inscriptions"]};var d=n(`<p><strong><em>Please note that you are currently viewing a beta version of the new I.Sicily interface</em></strong><br> This interface is currently under development in collaboration with <a href="https://kdl.kcl.ac.uk/projects/crossreads/" rel="nofollow">King’s Digital Lab</a>. The old interface remains online at: <a href="http://sicily.classics.ox.ac.uk" rel="nofollow">http://sicily.classics.ox.ac.uk</a>.<br></p> <p>I.Sicily is a long-term project to construct and maintain a digital corpus of
...
brick and tile, and coin legends. The corpus remains very much a work-in-progress, and files are liable to further editing.</p> <p>I.Sicily employs the <a href="https://sourceforge.net/p/epidoc/wiki/Home/" rel="nofollow">EpiDoc TEI-XML standard</a>.
...
download. All editing takes place in GitHub (which provides a full version history) and the data can also be accessed through the public <a href="https://github.com/ISicily/ISicily" rel="nofollow">I.Sicily repository</a>. We also present high resolution images where available, via a IIIF server (currently being upgraded). Bibliography is published in <a href="https://www.zotero.org/groups/382445/isicily/library" rel="nofollow">Zotero</a>, but also in the <a href="https://biblio.inscriptiones.org/" rel="nofollow">FAIR Epigraphy bibliography</a>.
Collection data (museums, sites, etc.) was originally gathered in a database of <a href="http://sicily.classics.ox.ac.uk/museums" rel="nofollow">Sicilian museums</a>.
Data is standardised and made potentially interopable by the use of
recognised vocabularies, such as the <a href="https://pleiades.stoa.org/" rel="nofollow">Pleiades gazetteer of ancient
places</a> and the <a href="https://www.eagle-network.eu/resources/vocabularies/" rel="nofollow">EAGLE epigraphic
vocabularies</a>.</p> <p>I.Sicily is currently part of the ERC Advanced Grant <a href="https://crossreads.web.ox.ac.uk/" rel="nofollow">CROSSREADS</a> (grant agreement no.885040). The aim of Crossreads is to develop and exploit the I.Sicily corpus for a detailed exploration of Sicilian epigraphic culture and to shed light on Sicilian history through the island’s epigraphy. Crossreads focuses on developing three major areas of data across the corpus: linguistic, palaeographic, and petrographic. Linguistic annotation has been undertaken on a subset of the corpus, alongside tokenisation and lemmatisation of the complete corpus. Palaeographic annotation has been undertaken through the development of a palaeographic annotation tool, which enables the assignment of letter typologies to linked images and texts. Petrographic analysis has been undertaken on hundreds of items across the corpus. The data from these three subprojects is being steadily integrated into the online corpus and will become available in the coming months.</p>`,1);function w(e,t){const a=l(t,["children","$$slots","$$events","$$legacy"]);h(e,c(()=>a,p,{children:(i,u)=>{var o=d();r(8),s(i,o)},$$slots:{default:!0}}))}export{w as component};
