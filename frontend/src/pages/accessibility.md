...
excerpt: Accessibility statement for I.Sicily
tags:
  - project
  - sicily
  - inscriptions
...
We are aware that some parts of ​I.Sicily​ could be not fully accessible due to the use of the third-party components for the following elements:
​​- Map views use [MapLibre](https://maplibre.org/maplibre-gl-js/docs/); 
...
This website is compliant with the [Web Content Accessibility Guidelines version 2.2](https://www.w3.org/TR/WCAG22/) AA standard; due to the use of third-party components mentioned above we have no control over compliance for those elements of the site. 
