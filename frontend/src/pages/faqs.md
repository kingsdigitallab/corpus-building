...
I.Sicily is a combination of data from published sources and from a very extended programme of fieldwork, which has involved undertaking autopsy (the direct study of the inscription in situ) and photography on sites and in museums across the island. We try to be explicit as much as possible about the source of key parts of the data - for instance, there should always be a note under the text indicating whether it is based upon autopsy or derived from a published edition.
