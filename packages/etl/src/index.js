...
// <p> elements under <handNote> carrying this @source marker are Types lists
// generated by the Crossreads annotator, not lettering descriptions
const ANNOTATOR_SOURCE_MARKER = "annotator";
...
/**
 * Escapes the HTML special characters of a string.
 *
 * @function escapeHtml
...
/**
 * Extracts the lettering description from the <p> elements of the <handNote>
 * in a TEI XML source, without relying on the XSLT transform.
 *
 * The description is the first <p> that is neither a Crossreads annotator
 * Types list (identified by its @source attribute) nor empty. Its content is
 ...
 * 
 * You MUST bust the html cache each time you change the logic in this
 * function (or sub-function). Either remove/truncate CACHE_FILENAME
 * or run `npm run etl -- --no-cache`
 *
 * @async
 ...
 */
async function transformToHtml(filePath, xmlString) {
  ...
  // 
  // // WRONGLY Assumes the first <p> under handNote is the description of the lettering.
  // // We can't use @source b/c epidoc doesn't convert it to html.
